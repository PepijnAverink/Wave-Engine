...
{
public:
	KeyDownEvent(const uint8_t _key, const uint32_t _info )
	...
	inline bool isPressed() const { return HIWORD(m_Info) & KF_REPEAT; } // TODO: make it platform independent

	static  EventType GetStaticType() { return EventType::EVENT_TYPE_KEY_DOWN; }
	virtual EventType  GetEventType() const { return GetStaticType(); }

	virtual const char* GetName()  const { return "KEY_DOWN_EVENT"; }
